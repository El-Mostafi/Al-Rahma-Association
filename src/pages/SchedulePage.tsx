...
function SchedulePage() {
  ...
  const getLessonImage = (subject: string) => {
    ...
    if (subject.includes("الفقه"))
      return "https://www.stjegypt.com/uploads/157492898184.jpg";
    if (subject.includes("العقيدة") || subject.includes("التوحيد"))
      return "https://www.stjegypt.com/uploads/157492898184.jpg";
    if (subject.includes("التجويد"))
      return "https://images.unsplash.com/photo-1609599006353-e629aaabfeae?w=400&h=300&fit=crop";
    return "https://www.daribnhazm.com/Storage/Library/Pub_5181/%D9%81%D9%87%D8%A7%D8%B1%D8%B3%20%D8%B4%D8%B1%D8%AD%20%D8%A7%D9%84%D8%B1%D8%B3%D8%A7%D9%84%D8%A9.png";
  };
                    ...
                    >
                      {dayData.lessons.map((lesson) => (
                        <SwiperSlide key={lesson.id} className="h-auto">
                          <div className="group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 h-full flex flex-col">
                            {/* Lesson Image */}
